...
function MemberTable({ members, onEdit, onDeleteMultiple }) {
    ...
    { field: "incomeType", headerName: "소득구분", width: 110 },
    {
      ...
      renderCell: (params) => (
        <Stack direction="row" spacing={1}>
          <Button size="small" color="primary" onClick={() => onEdit?.(params.row)}>
            수정
          </Button>
          <Button size="small" color="error" onClick={() => onDeleteMultiple?.([params.row.id])}>
            삭제
          </Button>
        </Stack>
      )
